...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String current_date= DateFormat.getDateInstance(DateFormat.FULL).format(calendar.getTime());
        ...
        SmsReceiver.bindListener(new SmsListener() {
            ...
            public void messageReceived(String sender, String messageText) {
                ...
                TextView textViewDate=MainActivity.this.findViewById(R.id.Viewdate);
